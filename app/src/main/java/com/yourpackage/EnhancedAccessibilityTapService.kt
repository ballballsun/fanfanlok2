...
class EnhancedAccessibilityTapService : AccessibilityService() {

    companion object {
        private const val TAG = "EnhancedAccessibilityTap"
    ...
    override fun onServiceConnected() {
        ...
        Log.d(TAG, "Enhanced Accessibility service connected and ready")
    }
