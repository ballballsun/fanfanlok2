...
class EnhancedOverlayService : Service() {
    ...
    private val automationStateReceiver = object : BroadcastReceiver() {
        override fun onReceive(context: Context?, intent: Intent?) {
            when (intent?.action) {
                EnhancedScreenCaptureService.ACTION_AUTOMATION_STATE -> {
                    val isRunning = intent.getBooleanExtra(EnhancedScreenCaptureService.EXTRA_IS_RUNNING, false)
                    val stats = intent.getParcelableExtra<EnhancedMatchLogic.GameStats>(EnhancedScreenCaptureService.EXTRA_GAME_STATS)
    ...
    private fun setupOverlayView() {
        // Inflate the enhanced overlay layout
        overlayView = LayoutInflater.from(this).inflate(R.layout.enhanced_overlay_layout, null)
    ...
    private fun registerAutomationReceiver() {
        val filter = IntentFilter(EnhancedScreenCaptureService.ACTION_AUTOMATION_STATE)
    ...
    private fun updateGameStats(stats: EnhancedMatchLogic.GameStats) {
        val statsText = """
